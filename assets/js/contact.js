(function ($) {
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", function (e) {
      ...
      // CONFIGURATION: Replace with your target WhatsApp number (include country code, no "+" or spaces)
      const whatsappNumber = "919226939822";
  ...
  /* Contact form WhatsApp Redirect end */
